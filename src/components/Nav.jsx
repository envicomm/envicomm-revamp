...
function Nav() {
    ...
    return (
        <nav className="bg-midgreen w-screen fixed top-0 left-0 z-10">
            <div className="container mx-auto flex flex-wrap items-center justify-between p-4 md:flex-nowrap">
                ...
                <div className={`w-full md:w-auto md:flex md:items-center ${isOpen ? "block" : "hidden"} md:block`}>
                    <ul className="flex flex-col md:flex-row font-semibold text-white md:justify-between md:space-x-4">
                        <li className="px-4 py-2"><Link to="/" onClick={() => setIsOpen(false)}>Home</Link></li>
                        <li className="px-4 py-2"><Link to="/About" onClick={() => setIsOpen(false)}>About</Link></li>
                        <li className="px-4 py-2"><Link to="/Services" onClick={() => setIsOpen(false)}>Services</Link></li>
